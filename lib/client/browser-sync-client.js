...
(function (window, socket) {
    ...
    var ghost = {
        ...
        simulateKeyboardEvent: function(keycode) {
            console.log("simulateKeyboardEvent :",keycode);
...
// 
                if (scope.ghostMode.enabled) {
                    ...
                    ghost.emitEvent("keyupBody", data);
    ...
    socket.on("keyupBody", function (data) {
        console.log("socket.io keyup:global :",data);
        ...
        if (elem) {
            ghost.simulateKeyboardEvent(data.keyCode)
        }
    });
